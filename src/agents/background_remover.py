    ...
    def remove_background(self, image_path: str, output_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if processed_image is None:
                # If no image was generated, this is a failure
                print("⚠️ No image generated by model - background removal failed")
                return {
                    "success": False,
                    "error": "Model did not generate an image. Please try again.",
                    "output_path": None,
